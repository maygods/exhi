...
function ExhibitionLib:CreateWindow(cfg)
    ...
    function WindowAPI:CreateTab(tcfg)
        ...
        function TabAPI:CreateSection(scfg)
            ...
            local secTitle = DrawTextWithShadow(secOut, secName, Fonts.Regular, 8.5 * GUI_SCALE, Colors.TextPrimary, UDim2.new(0, 7 * GUI_SCALE, 0, -5 * GUI_SCALE), Enum.TextXAlignment.Left, 5)
            ...
            function SectionAPI:CreateToggle(ecfg)
                ...
                local nameLbl = DrawTextWithShadow(btn, Capitalize(ecfg.Name or "Toggle"), Fonts.Regular, 8.5 * GUI_SCALE, Colors.TextDim, UDim2.new(0, 10 * GUI_SCALE, 0, 0), Enum.TextXAlignment.Left, 2)
            ...
            function SectionAPI:CreateSlider(ecfg)
                ...
                local nameLbl = DrawTextWithShadow(wrap, Capitalize(ecfg.Name or "Slider"), Fonts.Regular, 8.5 * GUI_SCALE, Colors.TextDim, UDim2.new(0, 0, 0, 0), Enum.TextXAlignment.Left, 2)
                ...
                local valLbl = DrawTextWithShadow(wrap, tostring(val)..suf, Fonts.Bold, 8.5 * GUI_SCALE, Colors.TextPrimary, UDim2.new(1, 0, 0, 0), Enum.TextXAlignment.Right, 2)
                ...
                local function UpdateVisuals()
                    if ExhibitionLib.DynamicSliders then
                        ...
                        valLbl.Size = UDim2.new(0, 40 * GUI_SCALE, 0, 8.5 * GUI_SCALE)
            ...
            function SectionAPI:CreateDropdown(ecfg)
                ...
                DrawTextWithShadow(wrap, Capitalize(ecfg.Name or "Dropdown"), Fonts.Regular, 8.5 * GUI_SCALE, Colors.TextDim, UDim2.new(0, 0, 0, 0), Enum.TextXAlignment.Left, 2)
                ...
                local selText = DrawTextWithShadow(boxIn, selected, Fonts.Regular, 8.5 * GUI_SCALE, Colors.TextMuted, UDim2.new(0, 2 * GUI_SCALE, 0, 0), Enum.TextXAlignment.Left, 2)
            ...
            function SectionAPI:CreateKeybind(ecfg)
                ...
                local nameLbl = DrawTextWithShadow(wrap, Capitalize(ecfg.Name or "Keybind"), Fonts.Regular, 8.5 * GUI_SCALE, Colors.TextDim, UDim2.new(0, 0, 0, 0), Enum.TextXAlignment.Left, 2)
                nameLbl.Size = UDim2.new(1, -32 * GUI_SCALE, 0, 8.5 * GUI_SCALE)
            ...
            function SectionAPI:CreateButton(ecfg)
                ...
                local lbl = DrawTextWithShadow(btnFill, Capitalize(ecfg.Name or "Button"), Fonts.Regular, 8.5 * GUI_SCALE, Colors.TextPrimary, UDim2.new(0, 0, 0, 0), Enum.TextXAlignment.Center, 2)
            ...
            function SectionAPI:CreateColorPicker(ecfg)
                ...
                local nameLbl = DrawTextWithShadow(wrap, Capitalize(ecfg.Name or "Color"), Fonts.Regular, 8.5 * GUI_SCALE, ThemeColor("TextDim"), UDim2.new(0, 0, 0, 0), Enum.TextXAlignment.Left, 2)
